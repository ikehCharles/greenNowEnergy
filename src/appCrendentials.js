...
const services = {
    ...
    body: [{
            ...
            summary: "We specialize in installing solar panels and power grid for household and commerial use",
        ...
        },
        {
            ...
            summary: "Prices starts at ₦56,200.40, our solar panel comes with an installation guide and free vouchers",
            body: "",
            buttonText: "Learn More",
        },
        {
            ...
            summary: "Our staffs are available 18 hours every day offering premium services and installation guide",
            body: "",
            buttonText: "Learn More",
        },
    ],
...
const product = {
    ...
    productHome: [{
            ...
            description: "Capacity of 2500VA, Multiple Built-in protection with a DC voltage of 24V (2 batteries), pure sine wave output and LCD display",
            link: "/product/1",
            price: "₦80,000",
        ...
        },
        {
            ...
            description: "Capacity of 1000VA, Multiple Built-in protection with a DC voltage of 24V (2 batteries), pure sine wave output and LCD display",
            link: "/product/2",
            price: "₦45,000",
        ...
        {
            name: "Genus 1.5kva",
            description: "Capacity of 1500VA, pure sine wave inverter, providing power backup that will sustain a range of domestic appliances or office equipment.",
            link: "/product/3",
            price: "₦40,000",
        ...
        {
            name: "Genus 1kva",
            description: "Capacity of 1000VA, pure sine wave inverter, providing power backup that will sustain a range of domestic appliances or office equipment.",
            link: "/product/1",
            price: "₦38,000",
...
const project = {
    ...
    body: [{
        ...
        {
            title: "Installation of 24 units 8 grid solar system for ultimate limited homes",
            summary: loremIpsum(),
